using DdApp.Services;
using DdApp.ViewModels.Pages;
using DdApp.ViewModels.Windows;
using DdApp.Views.Pages;
using DdApp.Views.Windows;
    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureAppConfiguration(c =>
            {
                ...
                c.AddJsonFile("app-settings.json", true, true);
            })
            .ConfigureServices((context, services) =>
            {
                ...
                // services.AddSqlServer<StudentsDbContext>(connectionString);
